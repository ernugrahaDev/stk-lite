...
## This version is a lightweight fork of [SuperTuxKart](https://supertuxkart.net), designed to run smoothly on low-end hardware such as the **Raspberry Pi 4** or older laptops.
...
* If you not want to build manualy for windows, use Linux
